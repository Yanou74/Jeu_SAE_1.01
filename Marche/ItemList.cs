...
namespace Marche
{
    class ItemList : GameScreen
    {
        ...
        private AnimatedSprite _fruit_legumes2;
        ...
        {
            /*ITEM D'INVENTAIRE */
            AddItem(gameTime, _fruit_legumes, "carottes_item", "0101CAROTTE", 2,1, itemList);
            ...
            /*ITEM DE MAP*/
            AddItem(gameTime, _fruit_legumes2, "carotte", "1101CAROTTE", 2, 1, itemList);
            AddItem(gameTime, _fruit_legumes2, "patate", "1101PATATE", 1, 1, itemList);
            AddItem(gameTime, _fruit_legumes2, "navet", "1101NAVET", 2, 1, itemList);
            AddItem(gameTime, _fruit_legumes2, "oignon", "1101OIGNON", 2, 1, itemList);
            AddItem(gameTime, _fruit_legumes2, "poivron", "1101POIVRON", 1, 1, itemList);
            AddItem(gameTime, _fruit_legumes2, "pastèque", "1101PASTEQUE", 2, 1, itemList);
            AddItem(gameTime, _fruit_legumes2, "citrouille", "1101CITROUILLE", 2, 1, itemList);
            AddItem(gameTime, _fruit_legumes2, "mais", "1101MAIS", 1, 1, itemList);
            AddItem(gameTime, _fruit_legumes2, "salade", "1101SALADE", 2, 1, itemList);
            AddItem(gameTime, _fruit_legumes2, "poireaux", "1101POIREAUX", 2, 1, itemList);
            AddItem(gameTime, _fruit_legumes2, "aubergine", "1101AUBERGINE", 1, 1, itemList);
            AddItem(gameTime, _fruit_legumes2, "mure", "1102MURE", 2, 1, itemList);
            AddItem(gameTime, _fruit_legumes2, "fraise", "1102FRAISE", 1, 1, itemList);
            AddItem(gameTime, _fruit_legumes2, "framboise", "1102FRAMBOISE", 2, 1, itemList);
            AddItem(gameTime, _fruit_legumes2, "tomate", "1101TOMATE", 2, 1, itemList);
            AddItem(gameTime, _fruit_legumes2, "haricot", "1101HARICOT", 1, 1, itemList);
            AddItem(gameTime, _fruit_legumes2, "raisin", "1102RAISIN", 2, 1, itemList);
